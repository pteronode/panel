...
class MakeClusterCommand extends Command
{
    protected $signature = 'p:cluster:make
                            ...
                            {--fqdn= : The domain name (e.g daemon.example.com) to be used for connecting to the daemon. An IP address may only be used if you are not using SSL for this daemon.}
    ...
    public function handle()
    {
        ...
        $data['fqdn'] = $this->option('fqdn') ?? $this->ask('Enter a domain name (e.g daemon.example.com) to be used for connecting to the daemon. An IP address may only be used if you are not using SSL for this daemon');
